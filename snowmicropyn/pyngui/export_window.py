...
class ExportDialog(QDialog):
    ...
    def _init_widgets(self):
        ...
        self.slope_exposition_lineedit = QLineEdit()
        self.slope_exposition_lineedit.setFixedWidth(widget_width())
        self.slope_exposition_lineedit.setValidator(QDoubleValidator())
        self.slope_exposition_lineedit.setAlignment(Qt.AlignRight)
    ...
    def _init_ui(self):
        ...
        item_layout.addWidget(self.slope_exposition_lineedit)
        item_layout.addWidget(QLabel('°'))
        metadata_layout.addLayout(item_layout)
